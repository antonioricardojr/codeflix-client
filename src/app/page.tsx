...
export default function Home() {
  ...
  return (<div className="mb-10">
    ...
    <div className="flex space-x-3">
      <button className="md-text-xl; flex cursor-pointer items-center gap-x-2 rounded
        bg-white px-5 py-1.5 text-sm font-semibold text-black  transition
        hover:opacity-75 md:px-8 md:py-2.5
        ">
        <PlayIcon className="h-6"/>
        Play
      </button>
      <button className="md-text-xl; flex cursor-pointer items-center gap-x-2 rounded
        bg-gray-400 px-5 py-1.5 text-sm font-semibold text-black  transition
        hover:opacity-75 md:px-8 md:py-2.5
        ">
